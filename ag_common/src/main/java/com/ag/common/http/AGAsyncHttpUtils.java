...
public class AGAsyncHttpUtils {
    ...
    private volatile static AGAsyncHttpUtils instance;

    public void initialize(String baseUrl, int timeOut) {
        BASE_URL = baseUrl;
        TimeOut = timeOut;
    }
     ...
     * @param <T>
     */
    public <T> void getRequest(final Context context, String url,
     ...
     * @param <T>
     */
    public <T> void postRequest(final Context context, String url,
                                RequestParams params, final Class<T> cc,
                                final IHttpResult<T> iHttpResult) {
        AsyncHttpClient client = new AsyncHttpClient();
        client.setTimeout(TimeOut);
