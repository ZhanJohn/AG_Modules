...
public class ViewFlow extends AdapterView<Adapter> {
    ...
    public void startAutoFlowTimer() {
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                // Log.i(VIEW_LOG_TAG, "mCurrentScreen+1 = " +
                // (mCurrentScreen+1));
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
			...
			/*
			 * if (getContext() instanceof IndexFragment) {
			 *
			 *
			 * }
			 */

                // IndexFragment.this.RequestViewFlow(false);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                // if (getContext() instanceof CompanyIndexActivity) {
                // CompanyIndexActivity m = (CompanyIndexActivity) getContext();
                // m.viewFlow.requestDisallowInterceptTouchEvent(true);
                // }
            ...
            case MotionEvent.ACTION_UP:
                ...
                // if (getContext() instanceof CompanyIndexActivity) {
                // CompanyIndexActivity m = (CompanyIndexActivity) getContext();
                // m.viewFlow.requestDisallowInterceptTouchEvent(false);
                // }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
			 ...
			 */
                ...
                // m.IndexFragment.viewFlow.requestDisallowInterceptTouchEvent(true);
                // }
    ...
    private void snapToScreen(int whichScreen) {
        ...
        if (!mScroller.isFinished()) {
            if (isEnter) {
                isEnter = false;
                // Log.i(VIEW_LOG_TAG, "if");
                return;
            } else {
                whichScreen = 1;
                isEnter = true;
                // Log.i(VIEW_LOG_TAG, "else");
        ...
        // Log.i(VIEW_LOG_TAG, "mNextScreen = " + mNextScreen);
    ...
    private void postViewSwitched(int direction) {
        ...
        // Log.e(VIEW_LOG_TAG, "mCurrentBufferIndex = " + mCurrentBufferIndex);
        ...
        // System.out.println("postViewSwitched mCurrentAdapterIndex " +
        // mCurrentAdapterIndex);
        // System.out.println("postViewSwitched mCurrentBufferIndex " +
        // mCurrentBufferIndex);
        // System.out.println("postViewSwitched mCurrentAdapterIndex % 2 " +
        // mCurrentAdapterIndex % 2);
