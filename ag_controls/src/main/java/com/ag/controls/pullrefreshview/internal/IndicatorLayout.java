...
public class IndicatorLayout extends FrameLayout implements AnimationListener {
    ...
    public IndicatorLayout(Context context, PullToRefreshBase.Mode mode) {
        ...
        Drawable arrowD = null;
        try {
            arrowD = getResources().getDrawable(
                    ResourceUtil.getDrawbleByName(context,
        ...
        final int padding = getResources().getDimensionPixelSize(
                ResourceUtil.getDimenByName(context,
        ...
        switch (mode) {
            case PULL_FROM_END:
                ...
                inAnimResId = ResourceUtil.getAnimByName(context,
                        "slide_in_from_bottom");
                // outAnimResId = R.anim.slide_out_to_bottom;
                outAnimResId = ResourceUtil.getAnimByName(context,
                        "slide_out_to_bottom");
                // setBackgroundResource(R.drawable.indicator_bg_bottom);
                setBackgroundResource(ResourceUtil.getAnimByName(context,
                        "indicator_bg_bottom"));
