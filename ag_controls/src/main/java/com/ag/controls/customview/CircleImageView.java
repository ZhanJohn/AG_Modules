...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(index, DEFAULT_BORDER_WIDTH);

        index = ResourceUtil.getStyleable(context,
                "CircleImageView_border_color");
        mBorderColor = a.getColor(index, DEFAULT_BORDER_COLOR);
    ...
    public void getBitmap(NetImageParam imageParam) {
        if (TextUtils.isEmpty(imageParam.getImgUrl())) {
            System.out.println("CircleImage is null !!!");
            this.setImageResource(imageParam.getDefaultImg());
            return;
        }

        System.out.println("CircleImage-Url=" + imageParam.getImgUrl());
        ...
        // Picasso.with(_context).load(imgUrl).placeholder(imageParam.getDefaultLoadBG()).error(imageParam.getDefaultImg()).into(this);
