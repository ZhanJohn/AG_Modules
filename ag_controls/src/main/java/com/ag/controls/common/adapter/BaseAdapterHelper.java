 ...
 */
package com.ag.controls.common.adapter;
...
public class BaseAdapterHelper {
     ...
     *
     * @param viewId     The view id.
     * @param imageParam The image params.
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setImageUrl(int viewId, NetImageParam imageParam) {
        NetImageView view = retrieveView(viewId);
        view.setImageUrl(imageParam);
...
//		Picasso.with(context).load(imageUrl).placeholder(loadRes).error(errorRes).into(view);
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setCircleImageUrl(int viewId, NetImageParam imageParam) {
        CircleImageView view = retrieveView(viewId);
        view.setBorderColor(imageParam.getBorderColor());
        view.setBorderWidth(imageParam.getBorderWidth());
        view.setImageUrl(imageParam);
        Log.i(BaseAdapterHelper.class.getSimpleName(), "circleimage-url=" + imageParam.getImgUrl());
//		ImageLoader.getInstance().displayImage("", view);
//		Picasso.with(context).load(imageUrl).placeholder(loadRes).error(errorRes).into(view);
        return this;
    }
    ...
    public BaseAdapterHelper setLayoutParam(int viewId, int width, int height) {
        View view = retrieveView(viewId);
