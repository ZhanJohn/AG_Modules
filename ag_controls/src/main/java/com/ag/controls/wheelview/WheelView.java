...
public class WheelView extends View {
    ...
    private void initResourcesIfNecessary() {
        try {
            if (centerDrawable == null) {
                centerDrawable = getContext().getResources().getDrawable(
                        ResourceUtil.getDrawbleByName(mContext, "wheel_val"));// R.drawable.wheel_val
        ...
        try {
            setBackgroundResource(ResourceUtil.getDrawbleByName(mContext,
                    "wheel_bg"));// R.drawable.wheel_bg
        } catch (Exception e) {
