...
public class PlatformListFakeActivity extends FakeActivity {
	...
	protected int OrientationLandScape = ActivityInfo.SCREEN_ORIENTATION_PORTRAIT;
	protected boolean hasButton=false;
	protected boolean hasTopTitle=false;
	...
	public void setTopTitle(boolean hasTopTitle){
		this.hasTopTitle=hasTopTitle;
	}

	public void setBottomButton(boolean hasButton){
