...
public class OnekeyShare implements PlatformActionListener, Callback {
	...
	private int OrientationLandScape = ActivityInfo.SCREEN_ORIENTATION_PORTRAIT;
	...
	public void SetOrientation(int orientation){
		this.OrientationLandScape = orientation;
	}

	public void setHasBottomButton(boolean hasBottomButton) {
		this.hasBottomButton = hasBottomButton;
	}
	...
	public void show(Context context) {
		...
		try {
			String themeName="com.ag.share.theme.classic.PlatformListPage";
			if(OnekeyShareTheme.SKYBLUE == theme){
				themeName="com.ag.share.theme.skyblue.PlatformListPage";
			}
			platformListFakeActivity = (PlatformListFakeActivity) Class.forName(themeName).newInstance();
		} catch (Exception e) {
			e.printStackTrace();
			return;
		}

		platformListFakeActivity.setPlatforms(platforms);
		platformListFakeActivity.setTopTitle(hasTopTitle);
		platformListFakeActivity.setBottomButton(hasBottomButton);
		platformListFakeActivity.SetOrientation(OrientationLandScape);
